                ...
                <div class="modal fade" id="modalNovaIteracao" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                            <a href="novaIteracao.php?fase=1" class="btn btn-success border col-md-12">Nova Iteração no Início</a>
                                <a href="novaIteracao.php?fase=2" class="btn btn-success border col-md-12">Nova Iteração na Elaboração</a>
                                <a href="novaIteracao.php?fase=3" class="btn btn-success border col-md-12">Nova Iteração na Contrução</a>
                                <a href="novaIteracao.php?fase=4" class="btn btn-success border col-md-12">Nova Iteração na Transição</a>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                            </div>
